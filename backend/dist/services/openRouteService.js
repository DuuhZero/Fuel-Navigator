...
class OpenRouteService {
    static async calcularRota(origem, destino, perfil = 'driving-car') {
        try {
            const response = await axios_1.default.post(`https://api.openrouteservice.org/v2/directions/${perfil}`, {
    ...
    static async reverseGeocoder(coords) {
        try {
            const response = await axios_1.default.get(`https://api.openrouteservice.org/geocode/reverse`, {
                params: {
                    point: {
                        lat: coords[1],
                        lon: coords[0]
    ...
    static async testarConexao() {
        try {
            const response = await axios_1.default.get('https://api.openrouteservice.org/v2/health', {
                headers: {
                    'Authorization': OPENROUTE_API_KEY
                }
            });
...
exports.OpenRouteService = OpenRouteService;
